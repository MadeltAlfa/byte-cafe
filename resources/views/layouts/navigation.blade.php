    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <a href="{{ route('bookings.show') }}" class="text-gray-700 hover:text-indigo-600 font-medium">Lihat
                    Booking</a>
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::check() && Auth::user()->latestBooking)
                        {{-- Asumsi user memiliki relasi latestBooking --}}
                        {{-- Jika Anda ingin ini juga menggunakan x-nav-link, pastikan rutenya terdefinisi dan bisa dicek keaktifannya --}}
                        <x-nav-link :href="route('bookings.show', ['booking' => Auth::user()->latestBooking->id])" :active="request()->routeIs('bookings.show') &&
                            request()->route('booking')->id === Auth::user()->latestBooking->id">
                            {{ __('Booking Terbaru Anda') }}
                        </x-nav-link>
                    @else
                        {{-- Jika tidak ada booking terbaru atau user belum login, tautkan ke daftar booking --}}
